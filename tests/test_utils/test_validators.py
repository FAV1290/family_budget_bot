...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param('+', id='lonely plus symbol'),
        pytest.param('.', id='lonely dot symbol'),
        pytest.param(',', id='lonely comma symbol'),
...
def test__is_expense_amount_valid__false_cases(raw_amount: str) -> None:
    assert not is_expense_amount_valid(raw_amount)
...
def test__is_expense_amount_valid__true_cases(raw_amount: str) -> None:
    assert is_expense_amount_valid(raw_amount)


def test__is_expense_amount_valid__passes_float_strings_in_spite_of_further_issues() -> None:
    assert is_expense_amount_valid('50.50')
