import uuid
from database_handlers import get_user_categories, save_new_category
...
def check_category_input(user_id, user_input):
...
def add_category(user_id, user_input):
    feedback = check_category_input(user_id, user_input)
    if feedback != 'ok':
        return feedback
